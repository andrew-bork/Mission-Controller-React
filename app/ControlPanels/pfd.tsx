...
export default function PrimaryFlightDisplay({roll = 0, pitch = 0} : {roll: number|null, pitch: number|null}) {
    ...
    return (
        ...
        <svg style={{maxWidth: "100%", maxHeight: "100%"}} viewBox="0 20 80 60" xmlns="http://www.w3.org/2000/svg" strokeLinecap="round" strokeLinejoin="round" stroke="black">
            ...
            <g clipPath="url(#artificial-horizon-clip)">
                <g transform={`rotate(${-roll}, 40, 40)`} strokeWidth="0.15" >
                    {/* Artificial Horizon */}
                    <g>
                        <rect x={0} y={-40+pitch * pitchScale} width={80} height={80} stroke="none" fill="#77ccff"></rect>
                        <rect x={0} y={40+pitch * pitchScale} width={80} height={80} stroke="none" fill="#9e532e"></rect>
                    </g>
